		...
		>
			...
			<DialogContent className="sm:max-w-lg">
				...
				{!cleanupId ? (
					...
					<AlertBlock type="warning">
						The target deployment succeeded and the data was migrated. Confirm
						the target is healthy before cleaning up the source server - its
						service and data are still there until you do.
					</AlertBlock>
				)}
